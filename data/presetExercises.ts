...
export const presetExercises: PresetExercise[] = [
  // PEITO
  {
    ...
    reps: 10,
    weight: 0,
    notes: `O supino reto com barra é um dos exercícios mais fundamentais para o desenvolvimento da parte superior do corpo, focando principalmente no peitoral maior, tríceps braquial e deltoide anterior.  
- Posição inicial: Deite-se em um banco reto, pés firmes no chão, coluna neutra.  
- Pegada: Empunhe a barra com as mãos um pouco mais afastadas que a largura dos ombros.  
- Descida: Abaixe a barra de forma controlada até a linha média do peito, cotovelos a 45°.  
- Subida: Empurre até quase estender totalmente os braços, sem travar os cotovelos.  
- Respiração: Inspire ao descer, expire ao subir.  
Importante manter as escápulas retraídas e evitar rebote no peito.`,
    gifUrl: "https://www.hipertrofia.org/blog/wp-content/uploads/2017/09/barbell-bench-press.gif",
  },
  {
    category: "Peito",
